...
{
    public ProxyPanel (Updater updater, ResourceBundle msgs, boolean updateAuth)
    {
        _updater = updater;
        _msgs = msgs;
    ...
    public void actionPerformed (ActionEvent e)
    {
        ...
        if ("ok".equals(cmd)) {
            ...
            _updater.configProxy(_host.getText(), _port.getText(), user, pass);
        } else {
    ...
    protected final Updater _updater;
