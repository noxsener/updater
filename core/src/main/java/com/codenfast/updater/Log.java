...
/**
 * A placeholder class that contains a reference to the log object used by the Updater code.
 */
public final class Log
{
    public static class Shim {
        ...
        protected final Logger _impl = Logger.getLogger("com.codenfast.updater");
    }
