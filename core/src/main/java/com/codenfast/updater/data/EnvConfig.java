...
public final class EnvConfig {
    ...
    public static EnvConfig create (String[] argv, List<Note> notes) {
        ...
        if (!appDirFile.exists()) {
            ...
            // installer to simply place a updater.jar file somewhere and create an OS shortcut
            // that runs updater with an appdir and appbase specified, and have updater create the
    ...
    /** Either {@code null} or fallback {@code appbase} to use if one cannot be read from a
      * {@code updater.txt} file during startup. */
