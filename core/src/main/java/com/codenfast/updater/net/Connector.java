...
public class Connector {
    ...
    public void download (URL url, File target) throws IOException {
        ...
        // if the updater.txt file, for example, changes in the meanwhile, we would never hear
        // about it; turning off caches is not a performance concern, because when Updater asks
